...
> **Status:** v2.198 research loop · **1467 local tests, 7 skipped** · **1474 Vulcan tests with LALSuite installed** · **38 theoretical constraints (+4 ingested-data)** · **14 framework encoders** · **8 Wilson coefficients** · **9 observables** · **309 indexed result notes**
>
...
The latest loop, v2.170-v2.198, turns the most promising gravitational-wave route into an executable nonclaiming pipeline:
...
pip install -e ".[dev]"
pytest -q                                         # current full suite: 1467 passed, 7 skipped locally
