...
> **Status:** v2.192 research loop · **1428 local tests, 7 skipped** · **1435 Vulcan tests with LALSuite installed** · **38 theoretical constraints (+4 ingested-data)** · **14 framework encoders** · **8 Wilson coefficients** · **9 observables** · **303 indexed result notes**
>
...
The latest loop, v2.170-v2.192, turns the most promising gravitational-wave route into an executable nonclaiming pipeline:
...
pip install -e ".[dev]"
pytest -q                                         # current full suite: 1428 passed, 7 skipped locally
