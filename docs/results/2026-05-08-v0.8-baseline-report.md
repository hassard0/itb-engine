# ITB Engine — Full Battery: v0.8 baseline (8 constraints, 4 frameworks)

_Generated: 2026-05-08T04:15:29+00:00_
...
- Allowed cells: 10 / 961 (1.0 %)
- Phase components: 1 (sizes [10])

## Constraint importance ranking

- Baseline allowed: 10 / 961

| constraint | growth (cells) | growth fraction |
|---|---|---|
| anomaly_cancellation | 127 | 12.700 |
| scalar_convexity_g6_vs_g4 | 14 | 1.400 |
| causality_bound | 9 | 0.900 |
| bekenstein_tight | 6 | 0.600 |
