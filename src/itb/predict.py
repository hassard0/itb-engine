...
def predict(name: str) -> dict:
    ...
    cdot = float(HolographicComplexityRate().predict(fw.encode())[0])
    ...
    return {
        ...
        "observables": {
            ...
            "holographic_complexity_rate_lloyd_units": round(cdot, 4),
        },
...
def render(name: str) -> str:
    ...
    L.append(f"    holographic complexity dC/dt (Lloyd units, >1 = violated): {o['holographic_complexity_rate_lloyd_units']}")
    return "\n".join(L)
